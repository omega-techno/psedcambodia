<?php 
	...
	while($row=mysql_fetch_array($result)){
		$field=array($row['tel'],$row['business_profile'], $row['business_service']);
	}
?>
...
<link rel="stylesheet" href="css/menuadvertising.css" />
</head>

<body>
<div style="background-color:#414141; height:156px; min-width:1164px;">
	<?php
       	include('../include_file/header3.html');
	?>
</div>
<div id="store">
	<div id="storein">
    ...
    <div id="pagemiddle">
        ...
        <div id="business_profile">
            ...
            <div id="conract_phone" class="noma" style="color:#999; font-size:18px; margin-left:30px; margin-top:28px;">
            	CONTACT PHONE: <?php echo $field[0]; ?>
            </div>
        </div>
