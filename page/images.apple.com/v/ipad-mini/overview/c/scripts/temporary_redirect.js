...
r={desktop:"/ipad-mini/",iPhone:"/ipad-mini/index1.html"};function o(b){var d=b.split("../index.html");
var e=d[1];var c=d[2];var a=e;if(e==="ca"&&c==="fr"){a+="/"+c}else{if(e==="hk"&&c==="en"){a+="/"+c
}}if(Array.prototype.indexOf){if(z.indexOf(a)>=0){return"/"+a}}return""}function w(a){return a.match(/AppleWebKit/i)
}function A(a){return w(a)&&a.match(/iPad/i)}function y(a){return a.match(/iPhone/i)
}function x(a){return a.match(/iPod/i)}function s(a){return w(a)&&a.match(/Mobile/i)&&!A(a)
}function t(a){return s(a)||A(a)?parseFloat(a.match(/os ([\d_]*)/i)[1].replace("_",".")):0
}function B(a){if((y(a)||x(a))){return"iPhone"}else{return"desktop"}}p=o(u.location.pathname);
v=B(navigator.userAgent);q=p+r[v];if(u.location.pathname!==q){u.location=q}}(this));