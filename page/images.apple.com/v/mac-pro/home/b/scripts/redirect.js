...
r={desktop:"/mac-pro/",iPhone:"/mac-pro/index1.html"};function o(b){var d=b.split("../index.html");
var e=d[1];var c=d[2];var a=e;if(e==="ca"&&c==="fr"){a+="/"+c}else{if(e==="hk"&&c==="en"){a+="/"+c
}}if(z.indexOf(a)>=0){return"/"+a}else{return""}}function w(a){return a.match(/AppleWebKit/i)
...
}function B(a){if((y(a)||x(a))&&t(a)>5.9){return"iPhone"}else{return"desktop"}}p=o(u.location.pathname);
