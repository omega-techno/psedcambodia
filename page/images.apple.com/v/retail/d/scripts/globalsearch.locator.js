...
s=this};r.prototype={_RealtimeSearchMinListItems:5,_RealtimeSearchMinWaitTime:1000,_ShowSpinnerAfterNetworkDelayedByMs:600,_getURL:"/global/scripts/ac_googlemap_json.php?storename=Apple+Store&q=",_iconDirectory:"/retail/locator/images/icons/",_pinIconMap:["pin_a","pin_b","pin_c","pin_d","pin_e","pin_f","pin_g","pin_h","pin_i","pin_j"],_listViewIconMap:["list_a","list_b","list_c","list_d","list_e","list_f","list_g","list_h","list_i","list_j"],toggleGallery:function(d){var e=this._locatorView;
var b=p(".gallery-swap .featured-stores")[0];var c=p(".gallery-swap")[0];var a;
if(!b){d=true}this._eventManager.subscribeEvent(e,"webkitTransitionEnd",function(f){if(this===f.srcElement&&!a){c.removeChild(e);
e.style.webkitTransition=""}});this.toggleGallery=function(f){if(!f&&a){b.style.display="block";
e.style.position="absolute";if(q.getDOMVendor("webkit")){e.style.webkitTransition="opacity 0.4s ease";
e.style.opacity="0"}else{c.removeChild(e)}a=false}else{if(f&&!a){e.style.position="relative";
e.style.zIndex="1010";e.style.opacity="1";if(b){c.insertBefore(e,b);b.style.display="none"
}else{c.appendChild(e);this.toggleGallery=function(g){if(!g){this.setLocationToEmpty()
}}}a=true}}};this.toggleGallery(d)},_setupComplete:false,spinner:function(c){var b=document.createElement("div");
