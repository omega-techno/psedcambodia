...
};h.prototype={_constructGoogleMap:function(){this._googleMapInstance=new google.maps.Map(this._container,{zoom:this._zoom,maxZoom:(!this._canZoom)?this._zoom:this._maxZoom,minZoom:(!this._canZoom)?this._zoom:this._minZoom,mapTypeId:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!this._controls})
},_constructMarker:function(a,b,d){var c=e.shouldReplace()?b.replace(AC.Retina.rasterImageFormatRegExp(),"_2x$1"):b;
