AC.onDOMReady(function(){var b={element:AC.Element.select(".sticky")};if(b.element&&!AC.Element.getStyle(b.element,"position").match("sticky")){b.start=AC.Element.cumulativeOffset(b.element)[0];
