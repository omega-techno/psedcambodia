...
this.enhancedGlobalStylesheet.id="globalheader-enhanced-stylesheet";this.enhancedGlobalStylesheet.href=this.globalStylesheet.href.replace("navigation.html","enhanced.html");
...
if(searchSection!=="support"){var f=e[searchSection].replace("index.html",g)
...
if(typeof(window.searchHost)!=="undefined"&&window.searchHost===true){this.data.url=decodeURIComponent(this.data.url).replace("index.html",r);
...
return this};SearchShortcut.quickLinks=function(){this.baseShortcutsUrl="global/nav/scripts/shortcuts.php"
...
this.aiGetSuggestionsUrl=c+"/search/instant/getSuggestions"}else{this.aiGetSuggestionsUrl="search/instant/getSuggestions"
